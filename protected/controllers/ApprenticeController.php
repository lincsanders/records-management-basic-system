...
class ApprenticeController extends Controller
{
	...
	public function actionJson(){
		...
		foreach($apprentices as $apprentice)
			$aps[] = $apprentice->attributes;

		echo CJSON::encode($aps);
	}

	public function actionListAll(){
		$criteria = new CDbCriteria;

		if($_GET['field_officer']){
			$criteria->condition = "field_officer = ?";
			$criteria->params = array(
				$_GET['field_officer'],
			);
		...
		foreach((array)$apprentices as $model)
			$this->renderPartial('_listAll', array(
				'model' => $model,
			));
	}
	...
	{
		$model=Apprentice::model()->findByPk((int)$id);
		if($model===null)
